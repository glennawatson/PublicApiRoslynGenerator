...
/// </summary>
/// <remarks>
/// From roslyn4.14 the SDK's own style rules require a collection expression over
/// <c>ImmutableArray.Create</c>, which the floor cannot bind — hence the split by tier.
/// </remarks>
internal static class ImmutableArrays
{
    ...
    internal static ImmutableArray<T> Of<T>(T item) => [item];
    ...
    internal static ImmutableArray<T> Of<T>(params T[] items) => [.. items];
}
