...
/// <summary>
/// What Roslyn 5.3 and later can do, which is also what the roslyn5.6 slot compiles — nothing
/// relevant changed between them. Both halves of extension-block support exist, so a block renders
/// in full and reads back cleanly.
/// </summary>
internal static class RoslynFeatures
{
    ...
    /// </summary>
    internal static bool SupportsExtensionBlocks => true;
    ...
    /// </summary>
    internal static bool SupportsUserDefinedCompoundAssignment => true;
